...
TRANSLATIONS = {
    "zh_CN": {
        ...
        "log.subst_cleanup_failed": "无法删除临时盘符映射：{drives}。请手动执行 subst {drives} /d。",
    ...
    "en_US": {
        ...
        "log.subst_cleanup_failed": "Failed to remove temporary drive mappings: {drives}. Run subst {drives} /d manually.",
